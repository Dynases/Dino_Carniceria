...
#Region "Metodos Privados"
    ...
    Public Sub _prAplicarCondiccionJanusSinLote()
        ...
        fr = New GridEXFormatCondition(grProductos.RootTable.Columns("stock"), ConditionOperator.Equal, 0)
    ...
    Private Sub P_GenerarReporte(numi As String)
        ...
        If (Not pd.PrinterSettings.IsValid) Then
            ToastNotification.Show(Me, "La Impresora ".ToUpper + _Ds3.Tables(0).Rows(0).Item("cbrut").ToString + Chr(13) + "No Existe".ToUpper,
                                   ...
                                   eToastGlowColor.Blue, eToastPosition.BottomRight)
        Else
            objrep.PrintOptions.PrinterName = "EPSON L3110 Series" '_Ds3.Tables(0).Rows(0).Item("cbrut").ToString '"EPSON TM-T20II Receipt5 (1)"
            objrep.PrintToPrinter(2, True, 0, 0)
            'crystalReportDocument.PrintOptions.PrinterName = "your printer name"
            'objrep.PrintTicket("EPSON TM-T20II Receipt")
        End If
    ...
    Public Sub _prPedirLotesProducto(ByRef lote As String, ByRef FechaVenc As Date, ByRef iccven As Double, CodProducto As Integer, nameProducto As String, cant As Integer)
        ...
        listEstCeldas.Add(New Modelo.Celda("iccven", True, "Stock".ToUpper, 150, "0.000"))
        Dim ef = New Efecto
        ef.tipo = 3
        ef.dt = dt
        ef.SeleclCol = 2
                        ...
                        If (grdetalle.Row = grdetalle.RowCount - 1) Then
                            ...
                            If primerDigito = "2" Then
                                ...
                                If (existeProducto(codigoBarrasProducto)) Then
                                    If Len(codigoBarrasCompleto) < 12 Then
                                        Throw New Exception("Codigo de barras incompleto")
                                        Return
                                    End If
...
salirIf:
    ...
    Private Sub ponerProducto(codigo As String, resultado As Boolean)

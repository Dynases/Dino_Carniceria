...
#Region "TI002 MOVIMIENTOS "
    ...
    Public Shared Function L_prMovimientoEliminar(numi As String) As Boolean
        ...
        Return _resultado
    End Function
    Public Shared Function L_fnVerificarExistenciaVenta(_idProducto As String, _Lote As String, _Fecha As String) As Boolean
        Dim _resultado As Boolean
        ...
        _listParam.Add(New Datos.DParametro("@producto", _idProducto))
        _listParam.Add(New Datos.DParametro("@fechaVenc", _Fecha))
        _listParam.Add(New Datos.DParametro("@ibuact", L_Usuario))
        _Tabla = D_ProcedimientoConParam("sp_Mam_TI002", _listParam)
